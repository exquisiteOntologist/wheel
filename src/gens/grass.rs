...
// use crate::entities::{player, terrain};
// use crate::util::perlin::{self, PerlinNoiseEntity};
// use crate::{entities, util::perlin::sample_terrain_height};
// use bevy::ecs::system::{CommandQueue, SystemState};
use bevy::pbr::{
    ExtendedMaterial, MaterialExtension, MaterialExtensionKey, MaterialExtensionPipeline,
    MaterialPipeline, NotShadowReceiver,
};
// use bevy::render::color;
use bevy::render::mesh::{MeshVertexAttribute, MeshVertexBufferLayout, MeshVertexBufferLayoutRef};
use bevy::render::primitives::Aabb;
use bevy::render::render_asset::RenderAssetUsages;
use bevy::render::render_resource::{
    AsBindGroup, GpuArrayBuffer, RenderPipelineDescriptor, ShaderRef, SpecializedMeshPipelineError,
    VertexFormat,
};
...
const ATTRIBUTE_BASE_Y: MeshVertexAttribute =
    MeshVertexAttribute::new("BaseY", 988540917, VertexFormat::Float32);
const ATTRIBUTE_STARTING_POSITION: MeshVertexAttribute =
